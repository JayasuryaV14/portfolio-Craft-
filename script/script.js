...
function dtls(){
    window.location.href='gform.html';
}
function bot(){
...
const prompts = [
    ...
    [""],
    ["give a tag line","ha","lol","hehe","funny","joke"],   
    ["can i learn web development with you"],
  ...
  const replies = [
    ...
    ["Creative coder","Innovative developer and an student"],
    ["No i am Not for learning"],
    ["Select the template"]
  ]
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function addChat(input, product) {
    ...
    botImg.className = "images/user.png";
